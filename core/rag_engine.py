...
class MedicalRAGEngine:
    ...
    def __init__(self, config, database):
        ...
        # Initialize paths
        self.documents_path = Path(config.get('Paths', 'documents_path', 'data/documents'))
        self.images_path = Path(config.get('Paths', 'images_path', 'data/images'))
        self.embeddings_path = Path(config.get('Paths', 'embeddings_path', 'data/embeddings'))
