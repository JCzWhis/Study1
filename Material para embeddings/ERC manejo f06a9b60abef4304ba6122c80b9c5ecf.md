...
- Manejo etiológico
    - HTA
        ...
        De lo mejor para prevenir progresión. No hay consenso en objetivo.
        
        ACC: <130/80
        
        NICE: <140/90, <130/80 si proteinuria > 1g/día
        
        KDIGO: PAS <120
        
        ESC/ESH: PAS<140
        
        Primer elección: IECA, ARA2. Idealmente en combinación con diurético
        
        ![Untitled](Untitled%20107.png)
        
    - DM
        
        MTF si VFG>30 + iSGLT2 + aGLP1 de ser necesario
        
    - Hiperuricemia
        
        No hay evidencia suficiente si es asintomática, Objetivo AU <6 (<5 si tofos)
        
    - DLP
        
        Objetivo <70 o 55 en G4 y G5
        
        Usar Estatinas de eliminación hepática: ATV, Fluvastatina, Pitavastatina
...
- Prevención de progresión
    - Fármacos
        ...
        Disminuye unión a proteinas con aumento de la porción libre (MTX, indometacina, teofilina, Diazepam, Furo, Warfarina)
        
        Metabolitos acumulados (alopurinol, sulfonamidas, morfina, codeina)
        
        Hemodinamia renal (AINES, IECA, anfotericina B, inh calcineurina)
        
        Nefrotoxicidad por aminoglucosidos. 
        
        Aumento efecto por propofol, tiopental, barbitúricos
        
        Diazepam se acumula si VFG <10, reducir dosis
        
    - Nutrición
        
        Utilidad: tanto antiproteinúrica en pre-diálisis, como para prevenir sobrepeso y desnutrición, especialmente en diálisis.  
        
        Las recomendaciones de nutrientes deben adecuarse al peso ideal  -no real- y corregirse para el  gasto energético y la actividad física del paciente.
        
        Clásicamente las dietas muy restrictivas solo tienen un beneficio marginal y no un impacto determinante en la supervivencia.
        
        **Hidratación**
        
        Diálisis tomar tanto líquido como el que orine, más 500-750 cc adicionales.
        
        La ganancia interdialítica no debería exceder del 4-5% de su peso seco.
        
        En peritoneal, restricción líquida moderada y ajustándose a balances peritoneales.
        ...
        **Balance energético y síndrome metabólico**
        ...
        En líneas generales, el 50-60 % de las calorías debe ser en forma de carbohidratos (HC), es decir unos 275 gr (1.100 Kcal); preferiblemente complejos, de absorción lenta, para disminuir la síntesis de triglicéridos y mejorar la tolerancia a la glucosa. El 30-40 % restante, unos 100 gr (700 Kcal), se aportan en forma de ácidos grasos de predominio no saturado. Se recomienda mantener la siguiente proporción: Saturados <7%; poliinsaturados hasta 10% y monoinsaturados hasta 20% [28]. Estos nutrientes deben adecuarse conforme el estado lipídico e hidrocarbonado del paciente. En la [(Tabla 1)](https://static.elsevier.es/nefro/monografias/1/220/2701.png) y en la [(Figura 1)](https://static.elsevier.es/nefro/monografias/1/220/2757.png) se representan de forma esquemática las recomendaciones generales básicas del reparto de nutrientes y calorías para paciente con ERC E4-5 y en diálisis.
        
        La [obesidad](https://www.nefrologiaaldia.org/es-articulo-obesidad-progresion-enfermedad-renal-210) debe ser combatida de forma activa (IMC< 30 Kg/m2) como medida reno y cardio protectora, para prevenir el síndrome metabólico; como también para considerar la inclusión en lista de espera de trasplante renal. La pérdida de peso, debe realizarse bajo control del especialista en nutrición. De forma general, y a modo orientativo, se sugiere una restricción calórica diaria de 250-500 Kcal.
        
        **Ingesta proteica**
        
        Restricción moderada en ingesta de proteínas, en diálisis requieren subirse por el catabolismo.
        
        ***Restricción de proteínas*** 
        
        El riñón es el eliminador de productos nitrogenados, con la progresión de la falla los nitrogenados, fosfatos, sulfatos y ácidos orgánicos se acumulan. 
        
        Restricción de proteínas tiene efectos renoprotectores con efecto sinérgico con la reducción de ingesta salina y bloqueadores de SRAA.
        
        Dieta hipoproteica retrasa la progresión de ERC en 0,5 ml/min/año, no aplicable en poliquistosis renal, dudoso en no proteinúricas, beneficioso más en nefropatía DM.
        
        Mecanismos antiproteinúricos:
        
        - Hemodinámicos: por reducción de hiperfiltración
        - Metabólicos: Reducción de citoquinas
        
        Potenciales efectos beneficiones de la restricción proteíca
        
        - Reduce proteinuria
        - Retrasa progresión
        - Baja carga ácida de nefronas restantes
        - Reducción paralela de la ingesta de fósforo
        - Antioxidante
        - Mejora perfil lipídico
        - Antilitogénica (baja calciuria y uricosuria, aumenta citraturia)
        - Coadyuvante en control de sobrepeso
        - Mejora resistencia a la insulina
        
        ***Recomendación***
        
        Ingesta proteíca mínima 0,6 g/Kg/día. En población general 0,6-0,8. 
        
        0,8-0,9 es una propuesta razonable.
        
        Ceto o hidroxianálogos, combinados con dieta 20-30 g. Recomendación no consolidada.
        
        ***Recomendaciones en diálisis***
        
        Dado el carácter catabólico de la técnica, en HD la recomendación es de 1,1-1,2 gr/kg de peso ideal/día, hasta 1,4 según las series; y en DP ligeramente mayores, 1,2-1,5 gr/kg de peso ideal/día, con un 50% de proteínas de elevado valor biológico 
        
        Estas sugerencias varían sutilmente en las distintas Guías, incluso en editoriales de los mismos autores, aunque siempre es recomendable superar los 1,4 gr/kg de peso ideal/día en pacientes catabólicos o con signos de desgaste energético proteico 
        ...
        [Véase Parámetros Urinarios en ERCA](https://www.nefrologiaaldia.org/Par%C3%A1metros%20Urinarios%20en%20la%20Enfermedad%20Renal%20Cr%C3%B3nica%20%7C%20Nefrolog%C3%ADa%20al%20d%C3%ADa%20(nefrologiaaldia.org))
        ...
        **Estructuralmente la dieta conviene dividirla por grupos de nutrientes:**
        ...
        El sentido común marca las normas de una dieta completa y equilibrada, apoyándonos en recomendaciones sencillas. Cuatro comidas al día, balanceada en cuanto a los principios inmediatos (hidratos de carbono, grasas y proteínas) [(Figura 1)](https://static.elsevier.es/nefro/monografias/1/220/2757.png). El paciente puede dividir y combinar las raciones en todas las comidas, conforme a sus apetencias. La idea es dar una dieta relativamente libre y apetitosa y evitar ayunos prolongados.
        ...
        **Hidratación**
        ...
        En pacientes ERCA: Véanse los temas [Hidratación](https://www.nefrologiaaldia.org/es-articulo-hidratacion-enfermedad-renal-cronica-93) y [Parámetros Urinarios](https://www.nefrologiaaldia.org/es-articulo-parametros-urinarios-enfermedad-renal-cronica-185)
        ...
        **Ingesta salina**
        ...
        En pacientes ERCA el Na urinario no debería sobrepasar los 100 mEq/día (100-120 mEq/día puede considerarse un objetivo posibilista y razonable) [(Véase Parámetros Urinarios).](https://www.nefrologiaaldia.org/es-articulo-parametros-urinarios-enfermedad-renal-cronica-185)
        ...
        **Estas recomendaciones generales se ilustran en la [(Figura 3)](https://static.elsevier.es/nefro/monografias/1/220/2718.jpg) para el paciente con ERCA y en la [(Figura 4)](https://static.elsevier.es/nefro/monografias/1/220/2719.jpg) para el paciente en diálisis.**
        ...
        **Prebióticos, Probióticos, Simbióticos**
        ...
        Véase [Microbiota intestinal en la enfermedad renal crónica Nefrología 2016](https://www.nefrologiaaldia.org/es-articulo-microbiota-intestinal-enfermedad-renal-cronica-135)
        ...
        **Recomendaciones prácticas y vigilancia de la dieta**
        ...
        En la [(Tabla 1)](https://static.elsevier.es/nefro/monografias/1/220/2701.png) se describen las recomendaciones en términos absolutos, que deben trasladarse a los productos en formato de dieta. En la [(Figura 3)](https://static.elsevier.es/nefro/monografias/1/220/2718.jpg) se exponen las dietas aconsejadas en la ERCA E4-5 y en la [(Figura 4)](https://static.elsevier.es/nefro/monografias/1/220/2719.jpg) las dietas aconsejadas para el paciente en diálisis, en formato simplificado y divididas por grupos de nutrientes.
        ...
        Además de las encuestas dietéticas, para el caso de pacientes con ERCA, la determinación periódica de parámetros como el Na, Nitrógeno, P, K en orina de 24 horas [(Véase Parámetros Urinarios)](https://www.nefrologiaaldia.org/es-articulo-parametros-urinarios-enfermedad-renal-cronica-185), proporcionan información fiable de la adherencia a la dieta y hábitos nutricionales de nuestros pacientes.
        
        La adherencia a la dieta hipoproteica podemos estimarla de forma muy práctica a través de las pérdidas nitrogenadas en orina (asumiendo que el paciente se encuentra en balance proteico: ingesta=pérdidas) aplicando la ecuación descrita por Maroni BJ y col  [86] [96] [(Tabla 4)](https://static.elsevier.es/nefro/monografias/1/220/2703.png). ****En hemodiálisis se estima a partir de la generación de urea en el período interdiálisis [26] [97] y en diálisis peritoneal a través de la determinación de nitrógeno en el efluente peritoneal, más el nitrógeno urinario si es el caso [98] [99] [(Tabla 4)](https://static.elsevier.es/nefro/monografias/1/220/2703.png).
        ...
        A nivel más experimental la determinación urinaria de P, su excreción fraccional y la reabsorción tubular de fosfato, proporcionan información adicional sobre el manejo del P en ERCA [100] [(Véase Parámetros Urinarios)](https://www.nefrologiaaldia.org/es-articulo-parametros-urinarios-enfermedad-renal-cronica-185).
        
        Más recientemente, varias ecuaciones empleando iones en orina han demostrado utilidad en la estimación de la carga alcalina o ácida de las dietas [76] [83] [84] [(Véase Parámetros Urinarios).](https://www.nefrologiaaldia.org/es-articulo-parametros-urinarios-enfermedad-renal-cronica-185)
...
- Tratamiento de complicaciones
    - Sobrecarga de volumen
        ...
        Empieza a alterarse con VFG <15 (antes se regula bien)
        
        Restricción de sodio + diuréticos (ojo Tiazidas pierden efecto con VFG<30)
        
    - Hiperkalemia
        
        Más riesgo en oliguria, dieta rica en K, degradación de tejidos, hipoaldo (IECA, ARA2, nefropatia diabética)
        
        Dieta con menos de 2,7 g/día de K+, evitar IECA, ARA2, Antialdosterona, AINES, BB no selectivos, Anticalcineurininos, Cotrimoxazol
        
        Evitar salida del potasio: corregir acidosis, control glicemia, ajuste b-b, corregir nivel de digoxina.
    ...
    - **Anemia**
        ...
        **Etiología y Fisiopatología**
        ...
        Multifactorial.  VFG >60. 
        
        ***1) Disminución de EPO***
        
        Baja de HIF (factor inducible de hipoxia) → factor de transcripción regula expresión génica de EPO
        
        2) Uremia
        
        Deforma GR → hemólisis. 
        
        3) Déficit de hierro
        
        Baja absorción intestinal: por inflamación y hepcidina.
        
        Transferrina: saturación baja, transporte de hierro inadecuado
        
        4) Déficit de folato, vit B12, hierro
        
        Ácido fólico y B12 se pierden en la diálisis
        
        Pierden hierro, por sangrado crónico
        ...
        **Objetivo Hb 11-12**, no exceder 13 (KDOQI), otras guías: 10 a 12
        
        Manejo de déficit de hierro con objetivo de SatFe 30-50% **(>20%)** y ferritina 200-500 ng/ml
        
        Erotropoyetina 80-120 U/Kg SC, 3 a la semana o Darbepoyetina 0,75 mg/Kg cada 2 semanas
        
        - Ferritina bajo 100: Carga 1 ampolla postdiálisis x 10 veces (pasar en 1 hora)
        - Ferritina 100-400, SatFe <20%: Carga 1 ampolla postdiálisis x 10 veces (pasar en 1 hora)
        - Ferritina 100-400, SatFe >20%: EPO
        
        Mantención: 1 ampolla Venofer cada 15 días en última hora de diálisis
        
        Control de Ferritina cada 3 meses
        
    - Acidosis metabólica
        - Fisiopatología
            
            Riñón elimina ácidos órgánicos producidos por catabolismo de proteínas, empieza a fallar a partir de G4
            
            GAP normal o levemente aumentado (xq los riñones no son capaz de eliminar los ácidos)
            
        
        Bicarbonato VO si Bic <22 para evitar pérdida mineral ósea acelerada
        
        **Cálculo de la Dosis Inicial**:
        
        - **Dosis Inicial**: 0.5 mEq/kg/día a 1.0 mEq/kg/día.
        - Para este paciente: 0.5 x 70 kg = 35 mEq/día hasta 1.0 x 70 kg = 70 mEq/día.
        - Decidir empezar con una dosis intermedia, por ejemplo, 50 mEq/día.
        
        ### Pasos para la Administración de Bicarbonato de Sodio de Cocina
        
        1. **Calcular la Dosis**:
            - Una cucharadita de bicarbonato de sodio de cocina (aproximadamente 5 gramos) contiene alrededor de 60 mEq de bicarbonato.
        2. **Preparar la Solución**:
            - Disolver la cantidad adecuada de bicarbonato de sodio en agua para administrarlo oralmente.
            - Dividir en 2 dosis
    - Sangrado urémico
        
        Por alteración plaquetaria
        
        Corregir anemia, desmopresina 0,3 ug/KG EV o 3 ug/K intranasal, crioprecipitado, estrógenos, inicio de HD. 
        
    - Pericarditis
        
        Diálisis, descartar taponamiento
        
    - Neuropatía
        
        Riesgo de encefalopatía, polineuropatía y mononeuropatía, sindrome de piernas inquietas
...
- Terapia de reemplazo renal
    - Indicaciones agudo:
        ...
        Electrolitos: K, Ca, PO4, lisis tumoral
        
        Intoxicaciones: metanol, etileglicol, MTF, litio, valproato, salicilatos, barbituricos, teofilina, talio. Podría ser para: carbamazepina, digitalicos, dabigatran
        
        Overload: sobrecarga de volumen con hipoxemia
        
        Uremia: pericarditis, encefalopatia, sangrado
        
    - Indicaciones en crónico
    - Tipos
        - Hemodiálisis
        - Peritoneal
            - Contraindicaciones:
                ...
                Incapacidad de autocuidado para la técnica
                
            
            Se puede usar inmediato, pero se reocmienda usar 10 a 14 dias después
            
        - Trasplante
    - Preparación
        - Acceso estable en Extremidad superior no dominante
            - FAV primarias
                
                De elección, considerar si VFG <25 o > 4 mg/dl, de progresión rápida
                
                Ojalá con anticipación de 6 meses según KDOQI
                
                No debe usarse para tomar PA ni tomar sangre
                
            - Injertos AV
                
                DE politetrafluoroetileno (PTFE), al menos 3-6 semanas antes
                
            - Catéteres tunelizados
                
                Flujos más bajos, riesgo de infección