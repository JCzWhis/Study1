...
Es una enfermedad sistémica que ocurre cuando las células inmunes del injerto reconoce al huésped como foráneo y atacan a las células del receptor.

Injerto (graft) se refiere al tejido trasplantado o donado

Huesped (host) es el recipiente

Es una complicación de trasplante de precursores hematopoyéticos alogénico

Clasificación

- Agudo clásico: <100 días
- Crónico: >100 días

Acute classic GVHD: Presents within 100 days of transplantation with classical clinical features of acute GVHD.

1. Persistent, recurrent, or late-onset acute GVHD: Manifests with clinical features of classic acute GvHD but after 100 days of transplantation.
2. Classic chronic GVHD: Presents after 100 days of transplant with classic clinical features of chronic GvHD.
3. Overlap syndrome: May present at any time post-transplant with features of both acute and chronic GvHD 
...
3. **Immune modulation factors**: The incidence of GvHD is lower with triple therapy (cyclosporine, methotrexate (MTX), and prednisone as compared with double therapy (cyclosporine and MTX) [[2]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). In the pre-clinical setting, statins can inhibit APC function and reduce the expression of MHC class II [[3]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
4. **Chemotherapy and radiation therapy**: High-dose chemotherapy leads to local tissue damage and increases in the level of circulating cytokines that lead to a cytokine storm. This increases the ability of immune cells in the graft to recognize host antigens. An increased incidence and severity of GvHD is associated with regimens that include total body irradiation as compared with chemotherapy alone [[4]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).

[Go to:](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)

## Epidemiology

Acute GVHD can occur in up to 50% of patients receiving hematopoietic stem cell transplantation (HCT) from a human leukocyte antigen (HLA)-matched sibling [[5]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#) [[6]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). The occurrence is typically higher in unmatched donors. The incidence of chronic GVHD ranges from 6% to 80% [[7]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). GVHD is considered one of the main causes of morbidity and mortality after HCT; more than 10% of patients will die from this complication [[8]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).

Risk factors of acute GVHD are higher degrees of HLA mismatch, prior acute GVHD gender disparity, older age of the donor and/or recipient, peripheral stem cell recipients, alloimmunization of the donor, Cytomegalovirus and Epstein Barr virus seropositivity [[9]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
Donor cytotoxic CD-8 t cells recognize host tissue as foreign and proliferate to cause severe organ damage (type IV cytotoxic T cell hypersensitivity reaction). Donor allograft T-cells are the main effector cells for GvHD and its pathogenesis can be divided into three phases (Figure 1) [[10]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
Chronic GVHD has many features in common with collagen vascular disorders and systemic sclerosis [[13]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). In the oral cavity, chronic GVHD may present as lichen planus with a risk of development to oral squamous cell carcinoma that differs from the classical pathology and seems to be more aggressive in patients with stem cell transplantation [[14]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). Recurrent infections can be a cause of death, and it is often a complication of immunosuppression [[15][16]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). Ocular involvement is an indicator of poor prognosis in GVHD. It usually affects the ocular surface and manifests with dry eye or keratoconjunctivitis sicca [[17]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).

[Go to:](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)

## Evaluation

Diagnosis is usually clinical. Traditionally the criteria as described by Billingham include the following: [[18]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)
...
All patients receiving HCT should undergo prophylactic treatment for GVHD. 

Treatment protocols differ by institution, but most commonly use a combination of cyclosporine and methotrexate is continued for several months post-transplantation. Antibacterial, antiviral, and antifungal prophylaxis is typically added post HCT to mitigate the risk of infections.
...
Infection, especially viral hepatitis, drug-induced liver injury, shock liver, immunotherapy-related hepatotoxicity, sinusoidal obstructive syndrome, and malignancy [[23]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
Nausea and vomiting, anorexia: iatrogenic (secondary to chemotherapy, immunosuppressants, radiation, antibiotics, opioids) [[24]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).

[Go to:](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)

## Staging

The two most famous systems for acute GVHD staging are the International Cone Marrow Transplant Registry (IBMTR) system (A-D) and Glucksberg grade (1-4) [[25][26]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). Staging is based on clinical manifestations and severity of organ involvement [[6]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
**Glucksberg grade [[26]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#):**
...
**International Cone Marrow Transplant Registry (IBMTR) Severity index [[26]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#):**
...
Mortality is generally higher in moderate to severe GVHD in comparison with mild disease [[8]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#) [[27]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). The 5-year survival rate of grade C is 25%, while grade 4 has a survival rate of 5% [[28]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#). There is a strong correlation between the response to first-line treatment and survival [[6]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).

Extensive skin involvement, diarrhea, thrombocytopenia, elevated liver enzymes, and involvement of the lung or liver are poor prognostic factors for acute or chronic GVHD [[29]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#) [[1]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).

[Go to:](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)

## Complications

GVHD is a complication of allogeneic hematopoietic stem cell transplant that can usually have other complications, including bronchiolitis obliterans syndrome, interstitial lung disease, obliterative bronchiolitis, organizing pneumonia, and pleuroparenchymal fibroelastosis.[[30]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)
...
Liver complications include endothelialitis, bile duct destruction, and pericholangitis, but a liver biopsy is not done routinely due to associated thrombocytopenia.[[5]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)

[Go to:](https://www.ncbi.nlm.nih.gov/books/NBK538235/#)

## Consultations

Nutritionists should evaluate patients with GI involvement due to a higher risk of malnutrition and abnormalities in zinc, magnesium, vitamin B12, and vitamin D [[31]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
**Mouth care:** dental hygiene with topical fluorides is suggested [[32]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
All the patients and caregivers should take vaccines against influenza and pneumococcus [[5]](https://www.ncbi.nlm.nih.gov/books/NBK538235/#).
...
Prueba del teclado xijoulang, bastante cómodo y efectivo, más encima en español, suena bastante bien, esta super bien.