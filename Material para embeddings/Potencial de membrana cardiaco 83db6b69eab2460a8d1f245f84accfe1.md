...
¿En qué es diferente el tejido cardiaco?

- Autogenerado
- Conducido de célula a célula en forma directa
- Tiene larga duración

***Potencial de membrana***

Está regulado por el paso de Sodio, Calcio y potasio que no pasan libremente por la membrana, sino que dependen de canales, intercambiadores y bombas.

![Esta figura representa el movimiento de iones en el hipotético caso de una célula permeable solo al potasio o al sodio. Si fuera solo potasio tiene a -90 y si fuera solo sodio a +70, pero en realidad esto llega a un equilibrio.](Untitled%20342.png)

Esta figura representa el movimiento de iones en el hipotético caso de una célula permeable solo al potasio o al sodio. Si fuera solo potasio tiene a -90 y si fuera solo sodio a +70, pero en realidad esto llega a un equilibrio.

***Potencial de acción cardiaco***

No es igual en todas las regiones del corazón 

Las célulass que actuan como marcapasos tienen el potencial de iniciar su potencial de acción en forma espontáneo. Su potencial se denomina de “respuesta lenta”, en cambio la del músculo cardiaco es de “respuesta rápida”
...
**Fase 0:** despolarización rápida → entrada de **sodio** rápida

**Fase 1:** reversión de la subida rápida → aumento leve de la permeabilidad al **potasio (iTo)**

**Fase 2:** plateau alargado → reducción de permeabilidad a potasio y aumento de permeabilidad a **calcio +  intercambiador calcio/sodio ( entran 3 sodio y sale 1 calcio)**

**Fase 3:** repolarización → aumento de permeabilidad a **potasio,** baja de sodio y calcio **(corriente de salida retrasada)**

Fase 4: vuelta al potencial de reposo

***Potenciales de acción de respuesta lenta***

Tienen una fase de depolarización lenta, un plateau corto y menos estable y repolarización a un potencial de reposo inestable.

Asociado a una entrada principalmente de calcio

¿Qué podría provocar la despolarización?

- Baja de permeabilidad de potasio progresiva
- Aumento lento de permeabilidad a sodio (↑ ratio permeabilidad Na/K  → se aleja del equilibrio del potasio)
- Aumento de permeabilidad de calcio

***Estado refractario***

Al final del potencial de acción, la membrana es relativamente refractaria y puede ser reexitada solo con estímulo mayor al normal. Esto es para evitar contracción tipo tetania.

 Table 2–1 lists a few of the major important
...
that is an isoform of the family of nonselective cation hyperpolarizationactivated,
cyclic nucleotide-gated (HCN) channels. This channel is
...
In the heart, cardiac muscle cells are branching and connected end-toend
with neighboring cells at structures called intercalated disks. These
...
1. Note that the action potentials shown in Figure 2–5 have been
...
distant from the SA node. Both cells have similarly shaped fast responsetype
action potentials, but their temporal displacement reflects the fact that
...
Mohrman D, Heller L. Cardiovascular Physiology. 9a Ed LANGE 2018